                        ...
                        <div class="media">
                            <div class="d-fex flex-column vote-controls">
                                <a title="This question is useful"
                                   class="vote-up {{Auth::guest()?'off':''}}"   onclick="event.preventDefault();
                                ...
                                <span class="votes-count">{{$question->votes_Counts}}</span>
                                <a title="This question is not useful" class="vote-down class="vote-up {{Auth::guest()?'off':''}}onclick="event.preventDefault();
